...
For private commands (bot management), please see the `private` folder.
For specific commands (server private commands), feel free to submit any kind of command for your server in the `custom` folder! Just create a pull request and I will add it to the bot
